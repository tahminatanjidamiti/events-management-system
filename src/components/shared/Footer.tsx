  ...
  return (
    <footer className="border-t dark:border-slate-700/70">
      <div className="container mx-auto py-10">
        <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div><div className="flex justify-start items-center gap-2">
            ...
            <h1 className="font-semibold text-transparent bg-clip-text bg-linear-to-r from-gray-700 from-5% via-amber-500 to-gray-700"><i>EventsVibe</i></h1>
          </div>
            <Link
              href="mailto:yoursylhetweb@gmail.com"
              className="hover:text-yellow-600 transition-colors"
            >
              Email: yoursylhetweb@gmail.com
            </Link>
          ...
          <div>
            ...
            <div className="flex justify-start items-center gap-6 text-sm mt-2">
              ...
              <Link href="https://github.com" target="_blank" className="p-2 rounded-full bg-yellow-600 hover:bg-yellow-700 border-2 border-amber-500 transition">
      ...
      <div className="text-sm flex justify-center items-center pb-2">
        © {new Date().getFullYear()} EventsVibe, All rights reserved.
      </div>
    </footer>
  );
}
